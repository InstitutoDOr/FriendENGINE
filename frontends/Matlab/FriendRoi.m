function varargout = FriendRoi(varargin)
...
configureVariable(friendObj, 'MNIMask', 'studydirhmat_spm_PM.nii.gz');   
...
configureVariable(friendObj, 'ActivationLevelMaskType', '1');

% changing the mask to the generated by the funcional localizer run
configureVariable(friendObj, 'ActivationLevelMask', 'glmdirtstats_features_RUN01_bin');
