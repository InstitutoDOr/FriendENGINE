...
**Functional Real-Time Interactive Endogenous
Neuromodulation and Decoding**
...
1.        COPYRIGHT AND SOFTWARE        3

2.        LICENSE        3

3.        OVERVIEW AND COMPARISON WITH STANDALONE FRIEND        4

4.        TCP/IP COMMUNICATION        6
...
5.3.        Initialization        8

5.4.        Finalization        8

5.5.        Volume        8

5.6.        Post Preprocessing        8

5.7.        PluginHandler class        8

6.        AVAILABLE PLUG-INS        9

6.1.        Code snippets from the LibROI plugin        9

7.        FRONTEND PARAMETERS CONFIGURATION        15

1. 1.COPYRIGHT AND SOFTWARE
...
1. 3.OVERVIEW AND COMPARISON WITH STANDALONE FRIEND
...
1.
  1. 5.6.POST PREPROCESSING

Called after the pre-processing of each volume.

1.
  1. 5.7.PluginHandler class
...
1.
  1. 6.1.Code snippets from the LibROI plugin
...
**                   ** vdb **.** interval **.** intervals**[**idxInterval**].**start **+** 1**);**
         ...
         // obtain ROI mean value. The MeanCalculation object

         // variable was initialized previously with the ROI mask in

         // Initialization function. calculateMeans method obtains the

         // mean for each ROI in the current volume

         meanCalculation **.** calculateMeans**(**meanbaseline**);**

         // Calculates the mean of the ROI for the current mean
...
1. 7.FRONTEND PARAMETERS CONFIGURATION
