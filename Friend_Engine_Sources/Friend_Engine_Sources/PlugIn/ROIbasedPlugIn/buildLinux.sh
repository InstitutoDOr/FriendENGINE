...
g++ -shared -o ../../Application/libROI.so ROIPlugIn.o vardb.o masks.o intervals.o utils.o fslfuncs.o filefuncs.o defs.o parser.o socket.o socket2.o statistics.o alglibinternal.o ap.o specialfunctions.o linalg.o alglibmisc.o  \
-L../../libFiles \
-L$FSLDIR/extras/lib \
-L$FSLDIR/lib \
-lm \
