sudo g++ -fPIC -g -c \
svmPlugIn.cpp ../vardb.cpp ../masks.cpp ../../FRIEND_Engine/confusionmatrix.cpp ../../FRIEND_Engine/filefuncs.cpp ../../FRIEND_Engine/filefuncs.cpp ../../FRIEND_Engine/parser.cpp ../../FRIEND_Engine/intervals.cpp ../../FRIEND_Engine/fslfuncs.cpp svmobj.cpp svmfuncs.cpp ../../FRIEND_Engine/socket.cxx ../../FRIEND_Engine/socket2.cpp ../../FRIEND_Engine/defs.cpp ../../libsvm/svm.cpp \
