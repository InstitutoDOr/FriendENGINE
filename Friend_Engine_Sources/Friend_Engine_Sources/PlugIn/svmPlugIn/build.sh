...
g++ -dynamiclib -o ../../Application/libBrainDecoding.dylib svmPlugIn.o confusionmatrix.o vardb.o masks.o intervals.o fslfuncs.o svmobj.o svmfuncs.o defs.o svm.o parser.o statistics.o socket.o socket2.o alglibinternal.o utils.o filefuncs.o ap.o specialfunctions.o linalg.o alglibmisc.o logObject.o \
-L../../libFiles \
-L$FSLDIR/extras/lib \
-L$FSLDIR/lib \
-lm \
