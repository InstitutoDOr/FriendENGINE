...
class SVMProcessing
{
   ...
   char cond1[BUFF_SIZE], cond2[BUFF_SIZE]; // obtain names of conditions | JD AUG2016
   ...
   // generates a list of correct indexes for training
   void fillVolumeIndexes(studyParams *&vdbPtr, vector<int>& indices);
