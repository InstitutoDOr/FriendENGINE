...
g++ -shared -o ../../Application/libconnectivity.so connectivityPlugIn.o vardb.o masks.o intervals.o socket.o socket2.o fslfuncs.o utils.o filefuncs.o defs.o parser.o statistics.o alglibinternal.o ap.o specialfunctions.o linalg.o alglibmisc.o \
-L../../libFiles \
-L$FSLDIR/extras/lib \
-L$FSLDIR/lib \
-lm \
