...
g++ -shared -o ../../Application/libMotor.so MotorPlugIn.o vardb.o masks.o utils.o intervals.o fslfuncs.o filefuncs.o defs.o parser.o socket.o socket2.o statistics.o alglibinternal.o ap.o specialfunctions.o linalg.o alglibmisc.o session.o logObject.o \
-L../../libFiles \
-L$FSLDIR/extras/lib \
-L$FSLDIR/lib \
-lm \
