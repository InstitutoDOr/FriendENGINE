...
g++ -o ../Application/engine main.o process.o engine.o PlugInHandler.o confusionmatrix.o session.o vardb.o  intervals.o socket.o socket2.o fslfuncs.o filefuncs.o defs.o parser.o utils.o \
-L../libFiles \
-L$FSLDIR/extras/lib \
-L$FSLDIR/lib \
-lm \
