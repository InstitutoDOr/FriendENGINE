...
del   FriendEngine\FriendEngine.VC.db
...
del   libEmotionROI\libEmotionROI.VC.db
...
del   libConnectivity\libConnectivity.VC.db
...
del   libBrainDecoding\libBrainDecoding.VC.db
