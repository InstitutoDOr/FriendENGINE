...
/**********************************************************************************************************/
extern unsigned long		GDCPIE_BGColor			DEFAULTO2( 0x000000L );	/* black */
extern unsigned long		GDCPIE_PlotColor		DEFAULTO2( 0xC0C0C0L );	/* gray */
extern unsigned long		GDCPIE_LineColor		DEFAULTO2( GDC_DFLTCOLOR );
extern unsigned long		GDCPIE_EdgeColor		DEFAULTO2( GDC_NOCOLOR ); /* edging on/off */

extern char				GDCPIE_other_threshold	DEFAULTO2( -1 );
extern unsigned short		GDCPIE_3d_angle			DEFAULTO2( 45 );			/* 0-360 */
extern unsigned short		GDCPIE_3d_depth			DEFAULTO2( 10 );			/* % image width */
extern unsigned short		GDCPIE_perspective		DEFAULTO2( 0 );			/* % view */
extern char				*GDCPIE_title			DEFAULTO2( NULL );		/* NLs ok here */
extern enum GDC_font_size	GDCPIE_title_size		DEFAULTO2( GDC_MEDBOLD );
extern enum GDC_font_size	GDCPIE_label_size		DEFAULTO2( GDC_SMALL );
#ifdef HAVE_LIBFREETYPE
extern char				*GDCPIE_title_font		DEFAULTO2( NULL );
extern char				*GDCPIE_label_font		DEFAULTO2( NULL );
extern double				GDCPIE_title_ptsize		DEFAULTO2( 0.0 );
extern double				GDCPIE_label_ptsize		DEFAULTO2( 0.0 );
#endif
extern int					GDCPIE_label_dist		DEFAULTO2( 1+8/2 );		/* 1+GDC_fontc[GDCPIE_label_size].h/2 */
extern unsigned char		GDCPIE_label_line		DEFAULTO2( FALSE );		/* from label to slice */

extern int					*GDCPIE_explode			DEFAULTO2( (int*)NULL );	/* [num_points] */
															/* [num_points] supercedes GDCPIE_PlotColor */
extern unsigned long		*GDCPIE_Color			DEFAULTO2( (unsigned long*)NULL );
extern unsigned char		*GDCPIE_missing			DEFAULTO2( (unsigned char*)NULL );	/* TRUE/FALSE */

extern GDCPIE_PCT_TYPE		GDCPIE_percent_labels	DEFAULTO2( GDCPIE_PCT_NONE );
extern char				*GDCPIE_percent_fmt		DEFAULTO2( "%.0f%%" );	/* printf fmt'ing */
/**********************************************************************************************************/
