...
/**********************************************************************************************************/
extern char				GDC_generate_img	  = TRUE;
extern GDC_image_type_t	GDC_image_type		  = GDC_PNG;
extern int					GDC_jpeg_quality  = -1;				/* 0-95 */

extern GDC_HOLD_IMAGE_T	GDC_hold_img		  = GDC_DESTROY_IMAGE;
extern void				*GDC_image			  = (void*)NULL;	/* in/out */
/**********************************************************************************************************/
