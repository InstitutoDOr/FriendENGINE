...
/**********************************************************************************************************/
extern char				*GDC_ytitle = NULL;
extern char				*GDC_xtitle = NULL;
extern char				*GDC_ytitle2 = NULL;		/* ostesibly: volume label */
extern char				*GDC_title = NULL;			/* NLs ok here */
extern enum GDC_font_size	GDC_title_size		DEFAULTO2( GDC_MEDBOLD );
extern enum GDC_font_size	GDC_ytitle_size		DEFAULTO2( GDC_MEDBOLD );
extern enum GDC_font_size	GDC_xtitle_size		DEFAULTO2( GDC_MEDBOLD );
extern enum GDC_font_size	GDC_yaxisfont_size	DEFAULTO2( GDC_SMALL );
extern enum GDC_font_size	GDC_xaxisfont_size	DEFAULTO2( GDC_SMALL );
extern double				GDC_xaxis_angle		DEFAULTO2( 90.0 );	/* 0,90. FT: 0-90 */
extern char				*GDC_ylabel_fmt		DEFAULTO2( NULL );		/* printf fmt'ing, e.g.: "%.2f" */
extern char				*GDC_ylabel2_fmt	DEFAULTO2( NULL );		/* default: "%.0f" future: fractions */
extern char				*GDC_xlabel_ctl		DEFAULTO2( NULL );		/* num_points[] TRUE,FALSE */
extern short				GDC_xlabel_spacing	DEFAULTO2( 5 );			/* pixels  SHRT_MAX means force all */
extern char				GDC_ylabel_density	DEFAULTO2( 80 );			/* % */
extern char				GDC_interpolations	DEFAULTO2( FALSE );		/* GDC_INTERP_VALUE in data */
extern float				GDC_requested_ymin	DEFAULTO2( GDC_NOVALUE );
extern float				GDC_requested_ymax	DEFAULTO2( GDC_NOVALUE );
extern float				GDC_requested_yinterval	DEFAULTO2( GDC_NOVALUE );
extern char				GDC_0Shelf			DEFAULTO2( TRUE );		/* if applicable */
extern GDC_TICK_T			GDC_grid			DEFAULTO2( GDC_TICK_LABELS );
extern GDC_TICK_T			GDC_ticks			DEFAULTO2( GDC_TICK_LABELS );
extern char				GDC_xaxis			DEFAULTO2( TRUE );
extern char				GDC_yaxis			DEFAULTO2( TRUE );
extern char				GDC_yaxis2			DEFAULTO2( TRUE );
extern char				GDC_yval_style		DEFAULTO2( TRUE );
extern GDC_STACK_T			GDC_stack_type		DEFAULTO2( GDC_STACK_DEPTH );
extern float				GDC_3d_depth		DEFAULTO2( 5.0 );		/* % img size */
extern unsigned char		GDC_3d_angle		DEFAULTO2( 45 );			/* 1-89 */
extern unsigned char		GDC_bar_width		DEFAULTO2( 75 );			/* % (1-100) */
extern GDC_HLC_STYLE_T		GDC_HLC_style		DEFAULTO2( GDC_HLC_CLOSE_CONNECTED );
extern unsigned char		GDC_HLC_cap_width	DEFAULTO2( 25 );			/* % (1-100) */
extern GDC_ANNOTATION_T	*GDC_annotation		DEFAULTO2( (GDC_ANNOTATION_T*)NULL );
extern enum GDC_font_size	GDC_annotation_font_size	DEFAULTO2( GDC_SMALL );
extern int					GDC_num_scatter_pts	DEFAULTO2( 0 );
extern GDC_SCATTER_T		*GDC_scatter		DEFAULTO2( (GDC_SCATTER_T*)NULL );
extern char				GDC_thumbnail		DEFAULTO2( FALSE );
extern char				*GDC_thumblabel;
extern float				GDC_thumbval		DEFAULTO2( -FLT_MAX );
extern GDC_BORDER_T		GDC_border			DEFAULTO2( GDC_BORDER_ALL );
extern unsigned long		GDC_BGColor			DEFAULTO2( 0x000000L );	 /* black */
extern unsigned long		GDC_GridColor		DEFAULTO2( 0xA0A0A0L );	 /* gray */
extern unsigned long		GDC_LineColor		DEFAULTO2( GDC_DFLTCOLOR );
extern unsigned long		GDC_PlotColor		DEFAULTO2( GDC_DFLTCOLOR );
extern unsigned long		GDC_VolColor		DEFAULTO2( 0xA0A0FFL );	 /* lgtblue1 */
extern unsigned long		GDC_TitleColor		DEFAULTO2( GDC_DFLTCOLOR ); /* "opposite" of BG */
extern unsigned long		GDC_XTitleColor		DEFAULTO2( GDC_DFLTCOLOR );
extern unsigned long		GDC_YTitleColor		DEFAULTO2( GDC_DFLTCOLOR );
extern unsigned long		GDC_YTitle2Color	DEFAULTO2( GDC_DFLTCOLOR );
extern unsigned long		GDC_XLabelColor		DEFAULTO2( GDC_DFLTCOLOR );
extern unsigned long		GDC_YLabelColor		DEFAULTO2( GDC_DFLTCOLOR );
extern unsigned long		GDC_YLabel2Color	DEFAULTO2( GDC_DFLTCOLOR );
							/* supercedes VolColor	ulong_color[num_points] */
extern unsigned long		*GDC_ExtVolColor	DEFAULTO2( (unsigned long*)NULL );
							/* supercedes LineColor	ulong_color[num_sets] */
extern unsigned long		*GDC_SetColor		DEFAULTO2( (unsigned long*)NULL );
							/* supercedes SetColor	ulong_color[num_sets][num_points] */
extern unsigned long		*GDC_ExtColor		DEFAULTO2( (unsigned long*)NULL );
extern char				GDC_transparent_bg	DEFAULTO2( FALSE );
extern char				*GDC_BGImage		DEFAULTO2( (char*)NULL );
extern char				GDC_hard_size		DEFAULTO2( FALSE );
extern int					GDC_hard_xorig		DEFAULTO2( 0 );				/* in/out */
extern int					GDC_hard_graphwidth	DEFAULTO2( 0 );				/* in/out */
extern int					GDC_hard_yorig		DEFAULTO2( 0 );				/* in/out */
extern int					GDC_hard_grapheight	DEFAULTO2( 0 );				/* in/out */
/**********************************************************************************************************/
