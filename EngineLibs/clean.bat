...
echo Removing intermediate files and directories of alglib
rmdir alglib\release /s /q
rmdir alglib\debug /s /q
rmdir alglib\x64 /s /q
...
echo Removing intermediate files and directories of miscplot
rmdir miscplot\release /s /q
rmdir miscplot\debug /s /q
rmdir miscplot\x64 /s /q
